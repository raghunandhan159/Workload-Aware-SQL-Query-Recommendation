...
setup_config = os.path.join('/Users/raghunandanvallabhaneni/Downloads/Workload-Aware-SQL-Query-Recommendation-Using-Deep-Learning-main/saved_models/configs/seq2seq/', sys.argv[1])
