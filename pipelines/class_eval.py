...
setup_config = os.path.join('/Users/raghunandanvallabhaneni/Desktop/setup_unaware.yaml')
...
setup_config = os.path.join('/Users/raghunandanvallabhaneni/Downloads/Workload-Aware-SQL-Query-Recommendation-Using-Deep-Learning-main/saved_models/configs/classification/', sys.argv[1])
with open(setup_config) as f:
    setup_config = yaml.safe_load(f)
